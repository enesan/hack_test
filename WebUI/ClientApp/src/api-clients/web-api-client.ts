...
export const ANCIENT_BASE_URL = new InjectionToken<string>('ANCIENT_BASE_URL');
...
export class AnswerClient {
  ...
  constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(ANCIENT_BASE_URL) baseUrl?: string) {
    this.http = http;
...
export class QuestionsBaseClient {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class QuestionsGroupClient {
  private http: HttpClient;
  private baseUrl: string;
  protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class QuestionsGroupDto extends BaseDto implements IQuestionsGroupDto {
  ...
  static override fromJS(data: any): QuestionsGroupDto {
    data = typeof data === 'object' ? data : {};
...
export class QuestionsBaseDto extends BaseDto implements IQuestionsBaseDto {
  ...
  static override fromJS(data: any): QuestionsBaseDto {
    data = typeof data === 'object' ? data : {};
